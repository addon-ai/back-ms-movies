...
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'libs', 'pygithub-integration'))
...
def apply_branch_protection():
    ...
    # Load config
    config_path = os.path.join(os.path.dirname(__file__), '..', 'libs', 'config', 'params.json')
